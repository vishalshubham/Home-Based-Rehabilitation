				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li class="active"><a href="questions_ans.php">Answered Questions</a></li>
						</ul></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
...
$result = mysql_query ( "SELECT q.qid, q.pid, q.description, q.time, q.ifans, a.did, a.content FROM questions AS q, answers AS a WHERE q.qid = a.qid AND q.ifans = 'Yes'" );
		...
		?>
				<div class="demo-frame-unans">
						<div id="demo-simplest">
							...
							<a href="#">Not answered. Click to give answer.</a>
						</div>
					</div>
					<hr>
<?php
